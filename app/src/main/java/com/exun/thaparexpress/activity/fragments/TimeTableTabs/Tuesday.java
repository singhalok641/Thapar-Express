...
public class Tuesday  extends Fragment {
    ...
    // Log tag
    private static final String TAG = "Tuesday";
    private Cursor tuesdayList;
    ...
    private void populateLecturesList() {
        ...
        String where = "id = '2'";
        tuesdayList = db.fetchColumnsByCondition(table, columns, where);
        recyclerView.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);
        recyclerView.setLayoutManager(mLayoutManager);
        mAdapter = new TimeTableAdapter(getActivity(), tuesdayList);

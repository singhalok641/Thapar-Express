 ...
 */
public class RVEventCAdapter extends RecyclerView.Adapter<RVEventCAdapter.DataHolderObject> {

    private static String LOG_TAG = "RVEventCAdapter";
    ...
    public RVEventCAdapter(List<EventsList> eventsItems) {

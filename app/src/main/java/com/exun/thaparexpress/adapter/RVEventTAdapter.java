 ...
 */
public class RVEventTAdapter extends RecyclerView.Adapter<RVEventTAdapter.DataHolderObject> {

    private static String LOG_TAG = "RVEventTAdapter";
    ...
    public RVEventTAdapter(List<EventsList> eventsItems) {
